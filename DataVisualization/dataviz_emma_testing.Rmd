...
```{r}
setwd("/Users/emmahorton/Documents/GitHub/world_happiness_report/DataAnalysis/Datasets")
...
Export Data to CSV
```{r}
write.csv(happydf,"/Users/emmahorton/Documents/GitHub/world_happiness_report/Cleaning/HappyDataFrame.csv", row.names=FALSE)
```
